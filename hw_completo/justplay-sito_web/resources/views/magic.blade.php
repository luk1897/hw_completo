...
<html>
    <head >
        ...
        <script src='{{ url("js\magic.js") }}' defer='true'></script>
        <title>
            JustPlay
      </title>
    </head>
    <body  id='b_info' >
      ...
      <section class='show_main'>
                    <h1 class='int_esp'>Scegli una carta del tuo gioco preferito</h1>
                    <button id='magic_b'>Ottieni carta</button>
                    <div class='main_flex_cards_tre'></div>
                    <div id='aux'></div>
      </section>
      <footer>
        <a href="">Servizi</a>
