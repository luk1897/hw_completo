...
<html>
    <head >
        ...
        <script src='{{ url("js\comics.js") }}' defer></script>
        <title>
            JustPlay
      </title>
 </head>
    <body  id='b_info' >
      ...
      <section class='show_main'>
            <h1 class='int_esp'>Cerca i fumetti del tuo eroe Marvel preferito</h1>
            <form id='form'>
                <input type="text" id='comics'>
                <input type="submit" id='comics_b' value='Cerca'>
            </form>
